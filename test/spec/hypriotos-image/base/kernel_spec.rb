...
describe command('uname -r') do
  its(:stdout) { should match /4.1.17(-v7)?+/ }
...
describe file('/lib/modules/4.1.17-hypriotos+/build') do
  it { should be_symlink }
  it { should be_linked_to '/usr/src/linux-headers-4.1.17-hypriotos+' }
end

describe file('/lib/modules/4.1.17-hypriotos-v7+/build') do
  it { should be_symlink }
  it { should be_linked_to '/usr/src/linux-headers-4.1.17-hypriotos-v7+' }
end

describe file('/usr/src/linux-headers-4.1.17-hypriotos-v7+') do
  it { should be_directory }
end

describe file('/usr/src/linux-headers-4.1.17-hypriotos+') do
  it { should be_directory }
end
